...
export function Contact({ isPage = false }: ContactProps) {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      Cal("init", "wtf-discovery", {origin:"https://app.cal.com"});
      
      Cal.ns["wtf-discovery"]("inline", {
        elementOrSelector:"#my-cal-inline-wtf-discovery",
        config: {"layout":"month_view"},
        calLink: "wtf.studios-kglgzg",
      });
      
      Cal.ns["wtf-discovery"]("ui", {"hideEventTypeDetails":false,"layout":"month_view"});
    `
          ...
          <div className="bg-background clean-border rounded-3xl overflow-hidden elevated-shadow">
            ...
            <div className="p-0 bg-white">
              <div
                ...
                id="my-cal-inline-wtf-discovery"
              />
            </div>
          </div>
        </div>
