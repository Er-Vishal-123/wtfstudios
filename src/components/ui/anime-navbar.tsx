                            ...
                            >
                                {isActive && (
                                    <motion.div
                                        ...
                                        initial={{ opacity: 0 }}
                                        animate={{
                                            opacity: [0.5, 0.8, 0.5], // Increased base opacity
                                            scale: [1, 1.05, 1]      // Slightly larger pulse
                                        }}
                                        transition={{
                                            duration: 2,
                                            repeat: Infinity,
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-[-12px] bg-primary/10 rounded-full blur-3xl" />

                                        {/* Brighter Shine */}
                                        <div
                                            className="absolute inset-0 bg-gradient-to-r from-primary/0 via-white/40 to-primary/0" // Brighter white shine
                                            style={{
                                ...
                                <AnimatePresence>
                                    {isHovered && !isActive && (
                                        <motion.div
                                            ...
                                            className="absolute inset-0 bg-white/15 backdrop-blur-sm rounded-full -z-10 border border-white/10"
                                        />
                                    )}
                                </AnimatePresence>
