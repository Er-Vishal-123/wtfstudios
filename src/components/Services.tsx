...
export function Services() {
  ...
  const services = [
    {
      id: 'ai-product',
      title: "AI Product Photoshoot & UGC",
      description: "Used AI to create studio-grade product photos and UGC-style content that looks real, relatable, and scroll-stopping — perfect for ads, websites, and marketplaces.",
      color: 'accent-purple',
      rotation: 'rotate-1',
      image: '/ai-product-photoshoot.png'
    },
    {
      id: 'campaigns',
      title: "AI Campaign & AI Ad Content",
      description: "We create AI-powered campaigns & ad creatives built to stop the scroll, blend into feeds, and drive clicks — fast, scalable, and performance-ready.",
      color: 'accent-emerald',
      rotation: 'rotate-2',
      image: '/ai-campaigns.png'
    },
    {
      id: 'brand-films',
      title: "AI Brand Films & Stories",
      description: "We craft cinematic brand films that feel real, hit emotions, and make people remember you — not just your product but also capture your essence and connect with audiences on an emotional level.",
      color: 'accent-blue',
      rotation: '-rotate-1',
    ...
    },
    {
      id: 'ai-automation',
      title: "AI Automation",
      description: "We build AI-powered automations that streamline operations, reduce manual work, and help teams move faster — from internal workflows to customer-facing systems.",
      color: 'accent-purple',
      rotation: 'rotate-1',
    ...
    },
    {
      ...
      description: "We design and build fast, scalable websites and apps that don't just look good — they convert. From landing pages to full-scale products, we turn ideas into clean, user-loved digital experiences.",
      color: 'accent-emerald',
      rotation: '-rotate-2',
    ...
    },
    {
      ...
      description: "We help brands build a consistent and meaningful presence across social platforms. From strategy to execution, we create high-quality content that strengthens brand identity, engages audiences, and supports business growth.",
      color: 'accent-blue',
      rotation: 'rotate-3',
  ...
  // Dynamic noise texture for paper effect
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 lg:gap-16 pt-20 max-w-7xl mx-auto px-4">
              {services.slice(0, 3).map((service, index) => (
                ...
                >
                  ...
                  {/* Photo */}
                  <div className="relative bg-white p-4 pb-8 shadow-2xl cursor-pointer w-[260px] sm:w-[280px] max-w-[90vw] overflow-hidden group/paper"
                    style={{
                      filter: hoveredPhoto === service.id ? 'brightness(1.02) contrast(1.02)' : 'brightness(1) contrast(0.95)',
                      boxShadow: `
                    ...
                    {/* Cool Iridescent Sheen on Hover */}
                    <div className="absolute inset-0 pointer-events-none z-10 opacity-0 group-hover/paper:opacity-100 transition-opacity duration-700"
                      style={{
                        background: 'linear-gradient(105deg, transparent 20%, rgba(255,0,150,0.1) 40%, rgba(255,255,255,0.4) 45%, rgba(0,255,255,0.1) 50%, transparent 70%)',
                        backgroundSize: '200% 200%',
                        animation: hoveredPhoto === service.id ? 'shimmer 1s forwards' : 'none'
                      }} />
                    {/* Photo Area */}
